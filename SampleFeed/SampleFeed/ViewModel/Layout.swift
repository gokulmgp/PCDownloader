...
class Layout: UICollectionViewLayout {
    ...
    fileprivate var numberOfColumns = (Device.IS_IPAD) ? 4:2
    ...
    func prepareCache() -> Void
    {
        ...
        for item in 0 ..< collectionView.numberOfItems(inSection: 0)
        {
            ...
            let photoHeight = delegate.collectionView(collectionView, cellWidth: columnWidth ,heightForPhotoAtIndexPath: indexPath)
